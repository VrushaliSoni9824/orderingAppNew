...
class TableData {
    ...
    constructor(ongoingOrder: OngoingOrder) {
        ...
        thirdparty = ongoingOrder.isthirdparty
        ...
        driver_assigned = ongoingOrder.is_driver_assigned
        driver_user_id = ongoingOrder.driver_user_id
        order_delivered = ongoingOrder.is_order_delivered
        payment_received = ongoingOrder.is_payment_received
        ...
        frontend_order = ongoingOrder.is_frontend_order
        qr_order = ongoingOrder.is_qr_order
